...
clusterSize <- 7; #change to 17
maxIterationSmallEM <- 5
amountOfSmallEM <- 16 #change to 10 or something like that
numberOfCores <- 16
...
saveRDS(nonDuplicatedCenters, file = paste('results/npCluster_smallEM',cpm,uuid(),'.RDS', sep = '_'))
